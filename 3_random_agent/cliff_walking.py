...
### CliffWalkingEnv Environment             #The CliffWalking environment is a simple environment of a 4x12 tiles, which has “cliffs” or terminal states on it
  
class CliffWalkingEnv():
#class CliffWalkingEnv(discrete.DiscreteEnv):    #The initial state has the agent starting at the tile on bottom left corner, with the goal to reach the tile at the bottom right corner, avoiding the cliffs in the process.
