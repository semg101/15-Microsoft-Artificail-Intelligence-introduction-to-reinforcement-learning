...
class Experiment(object):
    ...
    def run_agent(self, max_number_of_episodes=100, interactive = False, display_frequency=1):  #The run_agent() function is where the simulation for the random agent will run
